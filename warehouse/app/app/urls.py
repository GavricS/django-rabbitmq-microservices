...
from .views import ProductListCreateView, ProductRetrieveUpdateDestroyView, update_product_stock
...
urlpatterns = [
    ...
    re_path(r"^api/v1/products/stock/(?P<pk>\d+)/?$", update_product_stock, name="product-update-stock"),
