...
class OrderView(APIView):
    def get(self, request, format=None):
        try:
            order_data = get_basic_order_data()
            invoice_data = get_invoices_for_orders([order_datum["id"] for order_datum in order_data])

            data = merge_order_invoice_data(order_data, invoice_data)
...
def get_invoices_for_orders(order_ids):
...
def merge_order_invoice_data(order_data, invoice_data):
